...
func (Group) Fields() []ent.Field {
	return []ent.Field{
		...
		field.JSON("openai_request_overrides", domain.OpenAIRequestOverrides{}).
			Default(domain.OpenAIRequestOverrides{}).
			SchemaType(map[string]string{dialect.Postgres: "jsonb"}).
			Comment("OpenAI 分组级请求参数覆盖配置：service_tier/reasoning_effort/text_verbosity"),
