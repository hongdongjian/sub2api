...
const apiKeyAuthSnapshotVersion = 16 // v16: merge web search/video pricing and OpenAI request override fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			OpenAIRequestOverrides:          apiKey.Group.OpenAIRequestOverrides,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			OpenAIRequestOverrides:          snapshot.Group.OpenAIRequestOverrides,
